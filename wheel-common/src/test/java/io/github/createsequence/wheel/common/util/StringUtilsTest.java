...
public class StringUtilsTest {
    ...
    public void testMd5DigestAsHex() {
        ...
        String result1 = StringUtils.md5DigestAsHex(input1);
        Assert.assertEquals("65a8e27d8879283831b664bd8b7f0ad4", result1);

        // Test with empty string
        String input2 = "";
        String result2 = StringUtils.md5DigestAsHex(input2);
        Assert.assertEquals("d41d8cd98f00b204e9800998ecf8427e", result2);

        // Test with exception (catch block)
        Assert.assertThrows(RuntimeException.class, () -> StringUtils.md5DigestAsHex(null));
    }
}
