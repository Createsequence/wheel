...
public class ClassUtilsTest {
    ...
    public void forName() {
        ...
        Assert.assertEquals(ClassUtilsTest.class, ClassUtils.forName(ClassUtilsTest.class.getPackage().getName() + ".ClassUtilsTest"));
        Assert.assertThrows(WheelException.class, () -> ClassUtils.forName("not.found.class"));
        ...
        Assert.assertThrows(WheelException.class, () -> ClassUtils.forName("not.found.class", ClassUtilsTest.class));
    }
    ...
    public void newInstance() {
        ...
        Assert.assertThrows(WheelException.class, () -> ClassUtils.newInstance(Foo.class));
    }
