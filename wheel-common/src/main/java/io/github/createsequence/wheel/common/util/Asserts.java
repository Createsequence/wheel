...
public class Asserts {
    ...
    public static void isEquals(Object obj1, Object obj2, String message, Object... args) {
        isEquals(obj1, obj2, () -> new WheelException(message, args));
    }
    ...
    public static void isNotEquals(Object obj1, Object obj2, String message, Object... args) {
        isNotEquals(obj1, obj2, () -> new WheelException(message, args));
    }
    ...
    public static void isTrue(boolean expression, String message, Object... args) {
        isTrue(expression, () -> new WheelException(message, args));
    }
    ...
    public static void isFalse(boolean expression, String message, Object... args) {
        isFalse(expression, () -> new WheelException(message, args));
    }
    ...
    public static void isNotEmpty(Object object, String message, Object... args) {
        isNotEmpty(object, () -> new WheelException(message, args));
    }
    ...
    public static void isEmpty(Object object, String message, Object... args) {
        isEmpty(object, () -> new WheelException(message, args));
    }
    ...
    public static void isNotNull(Object object, String message, Object... args) {
        isNotNull(object, () -> new WheelException(message, args));
    }
    ...
    public static void isNull(Object object, String message, Object... args) {
        isNull(object, () -> new WheelException(message, args));
    }
}
