...
// TODO 用 WeakHashMap 替换
     ...
     * 解析方法的参数名。
     *
     * @param parameterNameDiscoverer 参数名查找器
     * @param method 方法
     * @return 参数名和参数的映射
     */
    @SuppressWarnings("all")
    public static Map<String, Parameter> resolveParameterNames(
        Function<Method, String[]> parameterNameDiscoverer, Method method) {
        Parameter[] parameters = method.getParameters();
